...
const Register = ({ onBack, onSuccess }) => {
  ...
  if (step === 'method') {
    return (
      <div className="min-h-screen register-container pride-firebase-theme flex items-center justify-center p-4">
        <div className="register-card rounded-3xl p-8 max-w-md w-full">
          <div className="text-center mb-8">
            <div className="flex items-center justify-center space-x-2 mb-4">
              <Heart className="h-8 w-8 text-purple-400" />
              <span className="text-2xl font-bold text-gradient-pride">
                Prisma
              </span>
            </div>
            <h2 className="text-3xl font-bold text-white mb-2">Únete Ahora</h2>
            <p className="text-gray-400">Elige cómo quieres registrarte</p>
          </div>

          <div className="space-y-4">
            <button 
              onClick={handleTelegramAuth}
              className="w-full btn-primary-pride py-4 rounded-xl font-semibold text-lg hover:shadow-lg transition-all duration-300 flex items-center justify-center space-x-3"
            >
            ...
            <button 
              ...
              className="w-full btn-firebase-pride py-4 rounded-xl font-semibold text-lg hover:border-purple-500 hover:shadow-lg transition-all duration-300 flex items-center justify-center space-x-3"
            >
  ...
  if (step === 'telegram') {
    return (
      <div className="min-h-screen register-container pride-firebase-theme flex items-center justify-center p-4">
        <div className="register-card rounded-3xl shadow-2xl p-8 max-w-md w-full text-center">
          <div className="mb-8">
            <div className="bg-white/10 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
              <Send className="h-8 w-8 text-blue-400" />
            </div>
            <h2 className="text-2xl font-bold text-white mb-2">Conectando con Telegram</h2>
            <p className="text-gray-400">Serás redirigido a Telegram para completar el registro de forma segura</p>
          </div>
      ...
      <div className="min-h-screen register-container pride-firebase-theme flex items-center justify-center p-4">
        <div className="register-card rounded-3xl p-8 max-w-md w-full">
          <div className="mb-8">
            <button 
              onClick={() => setStep('method')}
              className="text-gray-400 hover:text-white transition-colors flex items-center space-x-2 mb-4"
            >
              <ArrowLeft className="h-4 w-4" />
              <span>Volver</span>
            </button>
          ...
          <form onSubmit={handleEmailSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                required
                className="firebase-input w-full px-4 py-3 rounded-xl outline-none"
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  onChange={handleInputChange}
                  required
                  className="firebase-input w-full px-4 py-3 pr-12 rounded-xl outline-none"
            ...
            <button
              type="submit"
              className="btn-primary-pride w-full py-3 rounded-xl font-semibold"
            >
              Continuar
            </button>
          </form>
      ...
      <div className="min-h-screen register-container pride-firebase-theme flex items-center justify-center p-4">
        <div className="register-card rounded-3xl p-8 max-w-md w-full max-h-[90vh] overflow-y-auto">
          ...
          <form onSubmit={handleProfileSubmit} className="space-y-4">
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  onChange={handleInputChange}
                  required
                  className="firebase-input w-full px-4 py-3 pl-10 rounded-xl outline-none"
            ...
            <div>
              <label className="block text-sm font-medium text-gray-300 mb-2">Orientación</label>
              <select
                name="orientation"
                value={formData.orientation}
                onChange={handleInputChange}
                required
                className="firebase-input w-full px-4 py-3 rounded-xl outline-none bg-transparent"
              >
                <option value="" className="text-black">Selecciona tu orientación</option>
                <option value="gay" className="text-black">Gay</option>
                <option value="lesbian" className="text-black">Lesbiana</option>
                <option value="bisexual" className="text-black">Bisexual</option>
                <option value="transgender" className="text-black">Transgénero</option>
                <option value="queer" className="text-black">Queer</option>
                <option value="questioning" className="text-black">Cuestionando</option>
                <option value="asexual" className="text-black">Asexual</option>
              ...
              <div className="grid grid-cols-3 gap-2">
                {['ACTIVO', 'PASIVO', 'VERSATIL'].map((role) => (
                  <button
                    ...
                    className={`btn-firebase-pride py-2 px-3 rounded-lg text-sm font-medium transition-all ${
                      formData.role === role
            ...
            <div className="firebase-card p-4 !mb-4">
              <div className="flex items-start space-x-3">
                <Shield className="h-5 w-5 text-purple-400 mt-0.5" />
                <div>
                  <h4 className="font-medium text-purple-300">Tu privacidad es importante</h4>
            ...
            <button
              type="submit"
              className="btn-primary-pride w-full py-3 rounded-xl font-semibold flex items-center justify-center space-x-2"
            >
